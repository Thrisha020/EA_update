...
# Modified node_renderer section to include color palette
# Modified to offset node labels and improve layout
# All nodes will be colored sky blue
# Added interactivity: selection & hover policies
# Enhanced: uses curved edges to avoid overlap
# Enhanced: use better node spacing to prevent overlap and edge crossing
# Final: Fully spaced graph layout with label padding
import requests
