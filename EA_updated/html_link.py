...
from bokeh.models import HoverTool, Circle, MultiLine, LabelSet, ColumnDataSource, Div
...
if data:
    ...
    # Create a Div with the link to the HTML file
    html_link = f'<div style="margin-top: 20px;"><a href="file:///Users/thrisham/Desktop/MBANK70.BANK70A.htm" target="_blank">Open MBANK70.BANK70A</a></div>'
    div = Div(text=html_link)
